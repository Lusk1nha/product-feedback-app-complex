...
export function EditFeedbackForm({
	...
	return (
		<motion.div
			...
			initial="hidden"
			animate="visible"
			className="bg-white flex flex-col gap-y-6 rounded-lg pt-11 px-6 pb-6 md:pt-13 md:px-10 relative shadow-sm"
		>
			...
			<h1 className="text-h1 text-brand-dark">Editing ‘{initialData.title}’</h1>
